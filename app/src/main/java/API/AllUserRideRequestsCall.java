 ...
 */
public class AllUserRideRequestsCall extends AsyncTask {
    private ProgressDialog progressDialog;
    private Activity act;
    public IApiCaller delegate = null;
    public AllUserRideRequestsCall(Activity activity, IApiCaller delegate){
        act = activity;
    ...
    protected String doInBackground(Object[] objects) {
        ...
        String link = AppConstants.RideCon+"SelectRideRequests/?uid="+userid;
        String result ="";
        try{
