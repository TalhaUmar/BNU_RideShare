 ...
 */
public class ApiCallForJoinedRides extends AsyncTask {
    private ProgressDialog progressDialog;
    private Activity act;
    public IApiCaller delegate = null;
    public ApiCallForJoinedRides(Activity activity, IApiCaller delegate){
        act = activity;
    ...
    protected String doInBackground(Object[] objects) {
        ...
        String link = AppConstants.RideCon+"SelectJoinedRides/?uid="+uid;
        String result ="";
        try{
