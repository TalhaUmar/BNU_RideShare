 ...
 */
public class AcceptRejectRideRequestCall extends AsyncTask {
    @Override
    protected String doInBackground(Object[] objects) {
        int uid = (int) objects[0];
        int rid = (int) objects[1];
        String action = (String) objects[2];
        String link = AppConstants.RideCon + "AcceptRejectRideRequestNotify/?uid="+uid+"&rid="+rid+"&action="+action;
        String result = "";
        try {
