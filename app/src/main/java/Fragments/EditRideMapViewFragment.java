 ...
 */
public class EditRideMapViewFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        ...
        source.setText(rideModel.getSource());
        ...
        mapView.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                String parsestring = rideModel.getCheckpoints();
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        postButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final boolean[] ridejoiningsflag = {false};
                if (rideModel.getCheckpoints()!= null){
                    JoinedRidersCall joinedRiders = new JoinedRidersCall(getActivity(), new IApiCaller() {
                        @Override
                        public void onResult(String data) {
                            if (data != null) ridejoiningsflag[0] = true;
                        }
                    });
                    joinedRiders.execute(rideModel.getId());
                        if (ridejoiningsflag[0] == false){
                            RideUpdateCall rideUpdate = new RideUpdateCall(getActivity(), new IApiCaller() {
                            @Override
                            public void onResult(String data) {
                                if (data.equals("200")){
                                    Toast.makeText(getActivity(), "Ride updated successfully.", Toast.LENGTH_LONG).show();
                            ...
                            rideUpdate.execute(rideModel);
                        }
                        else{
                            Toast.makeText(getActivity(), "You cannot update when passengers have joined", Toast.LENGTH_LONG).show();
                        }

                }
                else {
                    checkpointerrorshow.setText("Select a route to update the ride !");
                }
